...
import 'support_email_screen.dart';
import 'support_telephone_screen.dart';

class AideSupportScreen extends StatelessWidget {
  const AideSupportScreen({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    _buildSupportCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const SupportEmailScreen()),
                        );
                      },
                    ),
                    SizedBox(height: 16.h),
                    _buildSupportCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const SupportTelephoneScreen()),
                        );
                      },
                    ),
