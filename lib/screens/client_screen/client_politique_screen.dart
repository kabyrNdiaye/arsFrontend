...
class ClientPolitiqueScreen extends StatelessWidget {
  const ClientPolitiqueScreen({Key? key}) : super(key: key);
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Center(
                      child: Padding(
                        padding: EdgeInsets.only(right: 64.w), // Pour compenser la largeur du bouton retour et icon
                        child: Text(
